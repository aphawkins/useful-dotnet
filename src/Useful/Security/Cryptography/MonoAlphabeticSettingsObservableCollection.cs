...
namespace Useful.Security.Cryptography
{
    ...
    public sealed class MonoAlphabeticSettingsObservableCollection : ISymmetricCipherSettings, INotifyPropertyChanged, INotifyCollectionChanged, IEnumerable<KeyValuePair<char, char>>
    {
        ...
        /// </summary>
        public MonoAlphabeticSettingsObservableCollection()
        {
        ...
        public static MonoAlphabeticSettingsObservableCollection Create(byte[] key, byte[] iv)
        {
            MonoAlphabeticSettingsObservableCollection settings = new MonoAlphabeticSettingsObservableCollection();
        ...
        public static MonoAlphabeticSettingsObservableCollection Create(ICollection<byte> key, ICollection<byte> iv)
        {
            MonoAlphabeticSettingsObservableCollection settings = new MonoAlphabeticSettingsObservableCollection();
            settings.Key = key;
            return settings;
        ...
        public static MonoAlphabeticSettingsObservableCollection GetDefault()
        {
        ...
        public static MonoAlphabeticSettingsObservableCollection GetRandom()
        {
            ICollection<byte> key = MonoAlphabeticSettingsObservableCollection.GetRandomKey(Letters.BasicLatinAlphabetUppercase, true);
            List<byte> iv = MonoAlphabeticSettingsObservableCollection.GetRandomIV();
            MonoAlphabeticSettingsObservableCollection settings = MonoAlphabeticSettingsObservableCollection.Create(key, iv);
            return settings;
        }
        ...
        /// <returns>Some randomly generated settings.</returns>
        public static MonoAlphabeticSettingsObservableCollection GetRandom(Collection<char> allowedLetters, bool isSymmetric)
        {
            ICollection<byte> key = MonoAlphabeticSettingsObservableCollection.GetRandomKey(allowedLetters, isSymmetric);
            ICollection<byte> iv = MonoAlphabeticSettingsObservableCollection.GetRandomIV();
            MonoAlphabeticSettingsObservableCollection settings = MonoAlphabeticSettingsObservableCollection.Create(key, iv);
            return settings;
        }
        ...
        private static MonoAlphabeticSettingsObservableCollection GetDefault(Collection<char> allowedLetters)
        {
            List<byte> key = MonoAlphabeticSettingsObservableCollection.GetDefaultKey(allowedLetters);
            List<byte> iv = MonoAlphabeticSettingsObservableCollection.GetDefaultIV();
            MonoAlphabeticSettingsObservableCollection settings = MonoAlphabeticSettingsObservableCollection.Create(key, iv);
            return settings;
        }
        ...
        {
            List<byte> key = (List<byte>)MonoAlphabeticSettingsObservableCollection.BuildKey(allowedLetters, allowedLetters, true);
            return key;
        }
        ...
        private static ICollection<byte> GetRandomKey(Collection<char> allowedLetters, bool isSymmetric)
        {
            ...
            List<byte> key = (List<byte>)MonoAlphabeticSettingsObservableCollection.BuildKey(allowedLetters, allowedLetters, isSymmetric);
            List<byte> iv = (List<byte>)MonoAlphabeticSettingsObservableCollection.BuildIV();

            MonoAlphabeticSettingsObservableCollection mono = MonoAlphabeticSettingsObservableCollection.Create(key, iv);
