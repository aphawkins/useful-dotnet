...
{
    public record NoteDuration : IComparable<NoteDuration>
    {
        ...
        public int TotalSamples(int samplesPerSecond) => samplesPerSecond * (((int)PartialNotes / (int)PartialNote.Whole) + ((int)PartialNotes % (int)PartialNote.Quarter));
