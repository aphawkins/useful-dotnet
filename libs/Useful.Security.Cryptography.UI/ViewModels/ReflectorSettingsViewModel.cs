...
namespace Useful.Security.Cryptography
{
    ...
    /// </summary>
    public sealed class ReflectorSettingsViewModel : CipherSettings, INotifyCollectionChanged
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReflectorSettingsViewModel"/> class.
        /// </summary>
        public ReflectorSettingsViewModel()
        ...
        public ReflectorSettingsViewModel(byte[] key)
        {
        ...
        public ReflectorSettingsViewModel(string characterSet, string substitutions)
            : base()
        {
